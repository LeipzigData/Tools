...
$local_store = false; /* set true to use the integrated store and if youre
		       * dumping data via turtle files (local or remote) set
		       * false if you want to retrieve data directly from a
...
//$trips = ARC2::getTriplesFromIndex($trips);
/* TODO this is nonsense and decreases performance, but I don't know how to
explain the plugin that the triples are resource indexed */
...
function filterData($store) {
  ...
  // query for local store (dumping all of it)
