...
\date{Version vom 14. Dezember 2018}
...
dieser Person beim Akteur) aufzuteilen.
...
Vererbungshierarchie.  Die Liste der Unterklassen wurde im Zuge des
Überarbeitung Ende 2018 um die Klassen \texttt{Bildungsangebot} und
\texttt{Beratungsangebot} erweitert.  

In der Anforderungsbeschreibung für eine Erweiterung (Ende 2017) wird weiter
ein Datensatztyp „Angebot“ sowie ein Typ „Ressource“ erwähnt.
...
\begin{itemize}\itemsep0pt
  ...
  \item Adresse (an der die Aktivität stattfindet)
...
Weitere Prädikate für Services (neu: Angebot?):
\begin{itemize}\itemsep0pt
